...
- (BOOL)readFromData:(NSData *)data ofType:(NSString *)typeName error:(NSError **)outError {
  ...
  // != NULL, ensure that you create and set an appropriate error if you return NO. Alternatively,
  // you could remove this method and override -readFromFileWrapper:ofType:error: or
  // -readFromURL:ofType:error: instead. If you do, you should also override -isEntireFileLoaded to
